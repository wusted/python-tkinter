...
class Counter_app():
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("tkinter tk Examples")
        self.create_widgets()
    ...
    def create_widgets(self):
        ...
        cmd_frame.grid(row=1, column=1, sticky=tk.E + tk.N + tk.S)

        button_label = ttk.Label(cmd_frame, text="tk.Button")
        button_label.grid(row=1, column=1, sticky=tk.E, pady=3)
        ...
        my_button = tk.Button(cmd_frame, text="press to do something")
        my_button.grid(row=1, column=2)

        my_button = ttk.Button(cmd_frame, text="press to do something")
        ...
        combobox_label = tk.Label(fromlist_frame, text="ttk.Listbox")
